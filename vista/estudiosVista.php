                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-2 mb-4">
                                <div class="col-auto me-auto mb-2">
                                    <h2 class="card-title">Gestión de Solicitudes de Estudios Médicos</h2>
                                </div>
                                <div class="col-auto">

                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalEstudios" id='btn_registrar'>
                                        Registrar
                                    </button>
                            ...
                            <div class="table-responsive">
                                <table id="tablaEstudios" class="table table-hover table-striped mt-3" style="width:100%">
                                    <thead>
                                        <tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalEstudiosLabel"></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                    <form id="formEstudios" action="" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="formEstudios" id="registrar" class="btn btn-success">registrar</button>
                    <button type="submit" form="formEstudios" id="modificar" class="btn btn-primary">modificar</button>
                </div>
            </div>
        </div>
    </div>
